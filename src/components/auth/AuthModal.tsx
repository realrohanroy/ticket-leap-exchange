...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[95vw] max-w-[100vw] sm:max-w-[425px] mx-2">
        <DialogHeader>
          <DialogTitle>Welcome to ShareMySeat</DialogTitle>
          <DialogDescription>
            Connect and travel together.
          </DialogDescription>
        </DialogHeader>

        <Tabs defaultValue="login" value={activeTab} onValueChange={(value) => { setActiveTab(value); setShowEmailForm(false); }} className="w-full">
